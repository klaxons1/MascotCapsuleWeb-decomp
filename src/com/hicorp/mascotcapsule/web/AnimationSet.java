...
public final class AnimationSet extends Class_15d5 {
   private final Config var_79;

   public AnimationSet(Config var1) {
      super(var1);
      this.var_79 = var1;
   }
   ...
   public void sub_22() {
      ...
      int var3 = Config.sub_509(this.var_79).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_79).sub_93();
      int var5 = Config.sub_509(this.var_79).sub_327(var3);
      int var6 = Config.sub_509(this.var_79).sub_3df(var3);
      int var7 = Config.sub_509(this.var_79).sub_418(var3);
      int var8 = Config.sub_509(this.var_79).sub_42b(var3);
      int var9 = Config.sub_509(this.var_79).sub_467(var3);
      ...
      int var13 = Config.sub_55c(this.var_79).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Config.sub_55c(this.var_79).sub_93();
      int var15 = Config.sub_55c(this.var_79).sub_327(var13);
      int var16 = Config.sub_55c(this.var_79).sub_3df(var13);
      int var17 = Config.sub_55c(this.var_79).sub_418(var13);
      int var18 = Config.sub_55c(this.var_79).sub_42b(var13);
      int var19 = Config.sub_55c(this.var_79).sub_467(var13);
