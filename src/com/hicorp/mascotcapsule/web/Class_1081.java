...
public final class Class_1081 extends Class_1279 {
   private final Class_6ed var_8a;

   public Class_1081(Class_6ed var1) {
      super(var1);
      this.var_8a = var1;
   }

   public void sub_1c() {
      int[] var1 = Class_6ed.sub_34c(this.var_8a);
      int var2 = (super.var_491 > 0 ? super.var_491 : -super.var_491) + (super.var_49f > 0 ? super.var_49f : -super.var_49f) + 32768;
      int var3 = Class_6ed.sub_509(this.var_8a).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Class_6ed.sub_509(this.var_8a).sub_93();
      int var5 = Class_6ed.sub_509(this.var_8a).sub_327(var3);
      int var6 = Class_6ed.sub_509(this.var_8a).sub_3df(var3);
      int var7 = Class_6ed.sub_509(this.var_8a).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_8a).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_8a).sub_467(var3);
      ...
      for (int var11 = super.var_49f >> var3; super.var_139 < super.var_21c; super.var_3c2 = super.var_3c2 + super.var_438) {
         ...
         super.var_139++;
         super.var_c4 = super.var_c4 + Class_6ed.sub_3dd(this.var_8a);
