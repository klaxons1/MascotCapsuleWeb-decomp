...
public final class Class_10ea extends ModelLoader {
   ...
   public void sub_26() {
      int[] var1 = Config.sub_34c(this.var_1e);
      int var2 = (super.var_2d1 > 0 ? super.var_2d1 : -super.var_2d1) + (super.var_319 > 0 ? super.var_319 : -super.var_319) + 32768;
      int var3 = Config.sub_509(this.var_1e).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_1e).sub_93();
      int var5 = Config.sub_509(this.var_1e).sub_327(var3);
      int var6 = Config.sub_509(this.var_1e).sub_3df(var3);
      int var7 = Config.sub_509(this.var_1e).sub_418(var3);
      int var8 = Config.sub_509(this.var_1e).sub_42b(var3);
      int var9 = Config.sub_509(this.var_1e).sub_467(var3);
      int var10 = super.var_2d1 >> var3;
      int var11 = super.var_319 >> var3;
      int var12 = super.var_339;
      int var13 = Config.sub_52c(this.var_1e);
      int var14 = 255 - Config.sub_52c(this.var_1e);
      if (super.var_6c < Config.sub_41a(this.var_1e)) {
         int var15;
         if (super.var_81 < Config.sub_41a(this.var_1e)) {
            var15 = super.var_81 - super.var_6c;
            super.var_6c = super.var_81;
         } else {
            var15 = Config.sub_41a(this.var_1e) - super.var_6c;
            super.var_6c = Config.sub_41a(this.var_1e);
         }

         super.var_31 = super.var_31 + Config.sub_3dd(this.var_1e) * var15;
      ...
      for (super.var_81 = super.var_81 < Config.sub_45d(this.var_1e) ? super.var_81 : Config.sub_45d(this.var_1e);
         super.var_6c < super.var_81;
         ...
         if (var27 < Config.sub_467(this.var_1e)) {
            int var20 = Config.sub_467(this.var_1e) - var27;
            var27 = Config.sub_467(this.var_1e);
            var17 += var10 * var20;
            var18 += var11 * var20;
            var19 += var12 * var20;
         }

         if (var16 > Config.sub_48e(this.var_1e)) {
            var16 = Config.sub_48e(this.var_1e);
         }
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Config.sub_3dd(this.var_1e);
