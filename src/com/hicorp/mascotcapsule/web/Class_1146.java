...
public final class Class_1146 extends Class_1279 {
   private final Config var_b0;

   public Class_1146(Config var1) {
      super(var1);
      this.var_b0 = var1;
   }
   ...
   public void sub_1c() {
      ...
      int var3 = Config.sub_509(this.var_b0).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      ...
      for (int var11 = super.var_49f >> var3; super.var_139 < super.var_21c; super.var_3c2 = super.var_3c2 + super.var_438) {
         ...
         super.var_139++;
         super.var_c4 = super.var_c4 + Config.sub_3dd(this.var_b0);
