...
public final class Class_118e extends Class_15c {
   private final Class_6ed var_42;

   public Class_118e(Class_6ed var1) {
      super(var1);
      this.var_42 = var1;
   }

   public void sub_26() {
      int[] var1 = Class_6ed.sub_34c(this.var_42);
      int var2 = (super.var_2d1 > 0 ? super.var_2d1 : -super.var_2d1) + (super.var_319 > 0 ? super.var_319 : -super.var_319) + 32768;
      int var3 = Class_6ed.sub_509(this.var_42).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Class_6ed.sub_509(this.var_42).sub_93();
      int var5 = Class_6ed.sub_509(this.var_42).sub_327(var3);
      int var6 = Class_6ed.sub_509(this.var_42).sub_3df(var3);
      int var7 = Class_6ed.sub_509(this.var_42).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_42).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_42).sub_467(var3);
      int var10 = super.var_2d1 >> var3;
      int var11 = super.var_319 >> var3;
      int var12 = super.var_339;
      if (super.var_6c < Class_6ed.sub_41a(this.var_42)) {
         int var13;
         if (super.var_81 < Class_6ed.sub_41a(this.var_42)) {
            var13 = super.var_81 - super.var_6c;
            super.var_6c = super.var_81;
         } else {
            var13 = Class_6ed.sub_41a(this.var_42) - super.var_6c;
            super.var_6c = Class_6ed.sub_41a(this.var_42);
         }

         super.var_31 = super.var_31 + Class_6ed.sub_3dd(this.var_42) * var13;
      ...
      for (super.var_81 = super.var_81 < Class_6ed.sub_45d(this.var_42) ? super.var_81 : Class_6ed.sub_45d(this.var_42);
         super.var_6c < super.var_81;
         ...
         if (var26 < Class_6ed.sub_467(this.var_42)) {
            int var18 = Class_6ed.sub_467(this.var_42) - var26;
            var26 = Class_6ed.sub_467(this.var_42);
            var15 += var10 * var18;
            var16 += var11 * var18;
            var17 += var12 * var18;
         }

         if (var14 > Class_6ed.sub_48e(this.var_42)) {
            var14 = Class_6ed.sub_48e(this.var_42);
         }
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Class_6ed.sub_3dd(this.var_42);
