...
public final class Class_11d7 extends MeshLoader {
   private final Config var_117;

   public Class_11d7(Config var1) {
      super(var1);
      this.var_117 = var1;
   }

   public void sub_81() {
      int[] var1 = Config.sub_34c(this.var_117);
      ...
      int var4 = Config.sub_509(this.var_117).sub_2cf(MatrixUtils.sub_30a(var3) - 17);
      int[] var5 = Config.sub_509(this.var_117).sub_93();
      int var6 = Config.sub_509(this.var_117).sub_327(var4);
      int var7 = Config.sub_509(this.var_117).sub_3df(var4);
      int var8 = Config.sub_509(this.var_117).sub_418(var4);
      int var9 = Config.sub_509(this.var_117).sub_42b(var4);
      int var10 = Config.sub_509(this.var_117).sub_467(var4);
      ...
      for (super.var_2c9 += 8388608; super.var_aa < super.var_bc; super.var_2c9 = super.var_2c9 + super.var_3a2) {
         ...
         super.var_aa++;
         super.var_5f = super.var_5f + Config.sub_3dd(this.var_117);
