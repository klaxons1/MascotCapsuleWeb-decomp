...
public final class Class_12c7 extends Class_15d5 {
   private final Config var_86;

   public Class_12c7(Config var1) {
      super(var1);
      this.var_86 = var1;
   }

   public void sub_22() {
      int[] var1 = Config.sub_34c(this.var_86);
      int var2 = (super.var_478 > 0 ? super.var_478 : -super.var_478) + (super.var_510 > 0 ? super.var_510 : -super.var_510) + 32768;
      int var3 = Config.sub_509(this.var_86).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_86).sub_93();
      int var5 = Config.sub_509(this.var_86).sub_327(var3);
      int var6 = Config.sub_509(this.var_86).sub_3df(var3);
      int var7 = Config.sub_509(this.var_86).sub_418(var3);
      int var8 = Config.sub_509(this.var_86).sub_42b(var3);
      int var9 = Config.sub_509(this.var_86).sub_467(var3);
      ...
      int var13 = Config.sub_55c(this.var_86).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Config.sub_55c(this.var_86).sub_93();
      int var15 = Config.sub_55c(this.var_86).sub_327(var13);
      int var16 = Config.sub_55c(this.var_86).sub_3df(var13);
      int var17 = Config.sub_55c(this.var_86).sub_418(var13);
      int var18 = Config.sub_55c(this.var_86).sub_42b(var13);
      int var19 = Config.sub_55c(this.var_86).sub_467(var13);
      ...
      for (int var21 = super.var_55b >> var13; super.var_8b < super.var_e8; super.var_383 = super.var_383 + super.var_460) {
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Config.sub_3dd(this.var_86);
