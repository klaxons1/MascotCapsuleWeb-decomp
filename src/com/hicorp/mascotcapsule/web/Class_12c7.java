...
public final class Class_12c7 extends Class_15d5 {
   private final Class_6ed var_86;

   public Class_12c7(Class_6ed var1) {
      super(var1);
      this.var_86 = var1;
   }

   public void sub_22() {
      int[] var1 = Class_6ed.sub_34c(this.var_86);
      int var2 = (super.var_478 > 0 ? super.var_478 : -super.var_478) + (super.var_510 > 0 ? super.var_510 : -super.var_510) + 32768;
      int var3 = Class_6ed.sub_509(this.var_86).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Class_6ed.sub_509(this.var_86).sub_93();
      int var5 = Class_6ed.sub_509(this.var_86).sub_327(var3);
      int var6 = Class_6ed.sub_509(this.var_86).sub_3df(var3);
      int var7 = Class_6ed.sub_509(this.var_86).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_86).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_86).sub_467(var3);
      ...
      int var13 = Class_6ed.sub_55c(this.var_86).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Class_6ed.sub_55c(this.var_86).sub_93();
      int var15 = Class_6ed.sub_55c(this.var_86).sub_327(var13);
      int var16 = Class_6ed.sub_55c(this.var_86).sub_3df(var13);
      int var17 = Class_6ed.sub_55c(this.var_86).sub_418(var13);
      int var18 = Class_6ed.sub_55c(this.var_86).sub_42b(var13);
      int var19 = Class_6ed.sub_55c(this.var_86).sub_467(var13);
      ...
      for (int var21 = super.var_55b >> var13; super.var_8b < super.var_e8; super.var_383 = super.var_383 + super.var_460) {
         ...
         for (int var28 = super.var_383 >> var13; var22 < var23; var22++) {
            ...
            int var35 = ((var31 & 16711935) * var32 & -16711936) + ((var31 & 0xFF00) * var32 & 0xFF0000) >>> 8;
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Class_6ed.sub_3dd(this.var_86);
