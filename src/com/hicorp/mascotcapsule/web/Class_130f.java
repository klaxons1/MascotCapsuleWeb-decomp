...
public final class Class_130f extends Class_15d5 {
   private final Config var_da;

   public Class_130f(Config var1) {
      super(var1);
      this.var_da = var1;
   }

   public void sub_22() {
      int[] var1 = Config.sub_34c(this.var_da);
      int var2 = (super.var_478 > 0 ? super.var_478 : -super.var_478) + (super.var_510 > 0 ? super.var_510 : -super.var_510) + 32768;
      int var3 = Config.sub_509(this.var_da).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_da).sub_93();
      int var5 = Config.sub_509(this.var_da).sub_327(var3);
      int var6 = Config.sub_509(this.var_da).sub_3df(var3);
      int var7 = Config.sub_509(this.var_da).sub_418(var3);
      int var8 = Config.sub_509(this.var_da).sub_42b(var3);
      int var9 = Config.sub_509(this.var_da).sub_467(var3);
      ...
      int var13 = Config.sub_55c(this.var_da).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Config.sub_55c(this.var_da).sub_93();
      int var15 = Config.sub_55c(this.var_da).sub_327(var13);
      int var16 = Config.sub_55c(this.var_da).sub_3df(var13);
      int var17 = Config.sub_55c(this.var_da).sub_418(var13);
      int var18 = Config.sub_55c(this.var_da).sub_42b(var13);
      int var19 = Config.sub_55c(this.var_da).sub_467(var13);
      int var20 = super.var_54a >> var13;
      int var21 = super.var_55b >> var13;
      if (super.var_8b < Config.sub_41a(this.var_da)) {
         int var22;
         if (super.var_e8 < Config.sub_41a(this.var_da)) {
            var22 = super.var_e8 - super.var_8b;
            super.var_8b = super.var_e8;
         } else {
            var22 = Config.sub_41a(this.var_da) - super.var_8b;
            super.var_8b = Config.sub_41a(this.var_da);
         }

         super.var_41 = super.var_41 + Config.sub_3dd(this.var_da) * var22;
      ...
      for (super.var_e8 = super.var_e8 < Config.sub_45d(this.var_da) ? super.var_e8 : Config.sub_45d(this.var_da);
         super.var_8b < super.var_e8;
         ...
         if (var41 < Config.sub_467(this.var_da)) {
            int var29 = Config.sub_467(this.var_da) - var41;
            var41 = Config.sub_467(this.var_da);
            var24 += var10 * var29;
            var25 += var11 * var29;
            var26 += var12 * var29;
            var27 += var20 * var29;
         ...
         if (var23 > Config.sub_48e(this.var_da)) {
            var23 = Config.sub_48e(this.var_da);
         }
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Config.sub_3dd(this.var_da);
