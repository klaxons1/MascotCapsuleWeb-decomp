...
public final class Class_1359 extends MeshLoader {
   private final Config var_14;

   public Class_1359(Config var1) {
      super(var1);
      this.var_14 = var1;
   }

   public void sub_81() {
      int[] var1 = Config.sub_34c(this.var_14);
      ...
      int var4 = Config.sub_509(this.var_14).sub_2cf(MatrixUtils.sub_30a(var3) - 17);
      int[] var5 = Config.sub_509(this.var_14).sub_93();
      int var6 = Config.sub_509(this.var_14).sub_327(var4);
      int var7 = Config.sub_509(this.var_14).sub_3df(var4);
      int var8 = Config.sub_509(this.var_14).sub_418(var4);
      int var9 = Config.sub_509(this.var_14).sub_42b(var4);
      int var10 = Config.sub_509(this.var_14).sub_467(var4);
      int var11 = super.var_3bf >> var4;
      int var12 = super.var_3d8 >> var4;
      int var13 = super.var_403;
      int var14 = super.var_45b;
      if (super.var_aa < Config.sub_41a(this.var_14)) {
         int var15;
         if (super.var_bc < Config.sub_41a(this.var_14)) {
            var15 = super.var_bc - super.var_aa;
            super.var_aa = super.var_bc;
         } else {
            var15 = Config.sub_41a(this.var_14) - super.var_aa;
            super.var_aa = Config.sub_41a(this.var_14);
         }

         super.var_5f = super.var_5f + Config.sub_3dd(this.var_14) * var15;
      ...
      super.var_bc = super.var_bc < Config.sub_45d(this.var_14) ? super.var_bc : Config.sub_45d(this.var_14);
      ...
      for (super.var_2c9 += 8388608; super.var_aa < super.var_bc; super.var_2c9 = super.var_2c9 + super.var_3a2) {
         ...
         if (var29 < Config.sub_467(this.var_14)) {
            int var21 = Config.sub_467(this.var_14) - var29;
            var29 = Config.sub_467(this.var_14);
            var17 += var11 * var21;
            var18 += var12 * var21;
            var19 += var13 * var21;
            var20 += var14 * var21;
         ...
         if (var16 > Config.sub_48e(this.var_14)) {
            var16 = Config.sub_48e(this.var_14);
         }
         ...
         super.var_aa++;
         super.var_5f = super.var_5f + Config.sub_3dd(this.var_14);
