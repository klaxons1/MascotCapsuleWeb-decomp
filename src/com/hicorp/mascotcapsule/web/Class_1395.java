...
public final class Class_1395 extends Class_1279 {
   private final Class_6ed var_52;

   public Class_1395(Class_6ed var1) {
      super(var1);
      this.var_52 = var1;
   }
   ...
   public void sub_1c() {
      ...
      int var7 = Class_6ed.sub_509(this.var_52).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_52).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_52).sub_467(var3);
      int var10 = super.var_491 >> var3;
      int var11 = super.var_49f >> var3;
      int var12 = Class_6ed.sub_52c(this.var_52);

      for (int var13 = 255 - Class_6ed.sub_52c(this.var_52); super.var_139 < super.var_21c; super.var_3c2 = super.var_3c2 + super.var_438) {
         ...
         super.var_139++;
         super.var_c4 = super.var_c4 + Class_6ed.sub_3dd(this.var_52);
