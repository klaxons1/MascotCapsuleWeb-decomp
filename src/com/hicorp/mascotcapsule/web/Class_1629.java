...
public final class Class_1629 extends Class_1279 {
   private final Config var_9d;

   public Class_1629(Config var1) {
      super(var1);
      this.var_9d = var1;
   }
   ...
   public void sub_1c() {
      ...
      int var3 = Config.sub_509(this.var_9d).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      ...
      if (super.var_139 < Config.sub_41a(this.var_9d)) {
         int var12;
         if (super.var_21c < Config.sub_41a(this.var_9d)) {
            var12 = super.var_21c - super.var_139;
            super.var_139 = super.var_21c;
         } else {
            var12 = Config.sub_41a(this.var_9d) - super.var_139;
            super.var_139 = Config.sub_41a(this.var_9d);
         }

         super.var_c4 = super.var_c4 + Config.sub_3dd(this.var_9d) * var12;
      ...
      for (super.var_21c = super.var_21c < Config.sub_45d(this.var_9d) ? super.var_21c : Config.sub_45d(this.var_9d);
         super.var_139 < super.var_21c;
         ...
         if (var13 > Config.sub_48e(this.var_9d)) {
            var13 = Config.sub_48e(this.var_9d);
         }
         ...
         super.var_139++;
         super.var_c4 = super.var_c4 + Config.sub_3dd(this.var_9d);
