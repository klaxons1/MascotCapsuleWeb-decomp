...
public final class Class_3ba extends ModelLoader {
   private final Config var_50;

   public Class_3ba(Config var1) {
      super(var1);
      this.var_50 = var1;
   }
   ...
   public void sub_26() {
      ...
      int var3 = Config.sub_509(this.var_50).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      ...
      if (super.var_6c < Config.sub_41a(this.var_50)) {
         int var13;
         if (super.var_81 < Config.sub_41a(this.var_50)) {
            var13 = super.var_81 - super.var_6c;
            super.var_6c = super.var_81;
         } else {
            var13 = Config.sub_41a(this.var_50) - super.var_6c;
            super.var_6c = Config.sub_41a(this.var_50);
         }

         super.var_31 = super.var_31 + Config.sub_3dd(this.var_50) * var13;
      ...
      for (super.var_81 = super.var_81 < Config.sub_45d(this.var_50) ? super.var_81 : Config.sub_45d(this.var_50);
         super.var_6c < super.var_81;
         ...
         if (var14 > Config.sub_48e(this.var_50)) {
            var14 = Config.sub_48e(this.var_50);
         }
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Config.sub_3dd(this.var_50);
