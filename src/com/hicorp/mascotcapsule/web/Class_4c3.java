...
public final class Class_4c3 extends Class_eda {
   ...
   public void sub_46() {
      int[] var1 = Config.sub_34c(this.var_5d);
      int var2 = Config.sub_397(this.var_5d);
      if (super.var_15e < Config.sub_41a(this.var_5d)) {
         int var3;
         if (super.var_170 < Config.sub_41a(this.var_5d)) {
            var3 = super.var_170 - super.var_15e;
            super.var_15e = super.var_170;
         } else {
            var3 = Config.sub_41a(this.var_5d) - super.var_15e;
            super.var_15e = Config.sub_41a(this.var_5d);
         }

         super.var_f1 = super.var_f1 + Config.sub_3dd(this.var_5d) * var3;
         super.var_1a2 = super.var_1a2 + super.var_201 * var3;
         super.var_1ac = super.var_1ac + super.var_24e * var3;
      }

      for (super.var_170 = super.var_170 < Config.sub_45d(this.var_5d) ? super.var_170 : Config.sub_45d(this.var_5d);
         super.var_15e < super.var_170;
         ...
         if (var4 > Config.sub_48e(this.var_5d)) {
            var4 = Config.sub_48e(this.var_5d);
         }
         ...
         super.var_15e++;
         super.var_f1 = super.var_f1 + Config.sub_3dd(this.var_5d);
