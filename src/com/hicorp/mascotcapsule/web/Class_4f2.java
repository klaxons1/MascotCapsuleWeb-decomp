...
public final class Class_4f2 extends ModelLoader {
   ...
   public void sub_26() {
      int[] var1 = Config.sub_34c(this.var_56);
      int var2 = (super.var_2d1 > 0 ? super.var_2d1 : -super.var_2d1) + (super.var_319 > 0 ? super.var_319 : -super.var_319) + 32768;
      int var3 = Config.sub_509(this.var_56).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_56).sub_93();
      int var5 = Config.sub_509(this.var_56).sub_327(var3);
      int var6 = Config.sub_509(this.var_56).sub_3df(var3);
      int var7 = Config.sub_509(this.var_56).sub_418(var3);
      int var8 = Config.sub_509(this.var_56).sub_42b(var3);
      int var9 = Config.sub_509(this.var_56).sub_467(var3);
      ...
      for (int var12 = super.var_339; super.var_6c < super.var_81; super.var_216 = super.var_216 + super.var_282) {
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Config.sub_3dd(this.var_56);
