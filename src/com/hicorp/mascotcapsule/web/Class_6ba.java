...
public final class Class_6ba extends Class_15d5 {
   private final Class_6ed var_99;

   public Class_6ba(Class_6ed var1) {
      super(var1);
      this.var_99 = var1;
   }
   ...
   public void sub_22() {
      ...
      int var7 = Class_6ed.sub_509(this.var_99).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_99).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_99).sub_467(var3);
      ...
      int var17 = Class_6ed.sub_55c(this.var_99).sub_418(var13);
      int var18 = Class_6ed.sub_55c(this.var_99).sub_42b(var13);
      int var19 = Class_6ed.sub_55c(this.var_99).sub_467(var13);
      int var20 = super.var_54a >> var13;
      int var21 = super.var_55b >> var13;
      int var22 = Class_6ed.sub_52c(this.var_99);
      int var23 = 255 - Class_6ed.sub_52c(this.var_99);
      if (super.var_8b < Class_6ed.sub_41a(this.var_99)) {
         int var24;
         if (super.var_e8 < Class_6ed.sub_41a(this.var_99)) {
            var24 = super.var_e8 - super.var_8b;
            super.var_8b = super.var_e8;
         } else {
            var24 = Class_6ed.sub_41a(this.var_99) - super.var_8b;
            super.var_8b = Class_6ed.sub_41a(this.var_99);
         }

         super.var_41 = super.var_41 + Class_6ed.sub_3dd(this.var_99) * var24;
      ...
      for (super.var_e8 = super.var_e8 < Class_6ed.sub_45d(this.var_99) ? super.var_e8 : Class_6ed.sub_45d(this.var_99);
         super.var_8b < super.var_e8;
         ...
         if (var43 < Class_6ed.sub_467(this.var_99)) {
            int var31 = Class_6ed.sub_467(this.var_99) - var43;
            var43 = Class_6ed.sub_467(this.var_99);
            var26 += var10 * var31;
            var27 += var11 * var31;
            var28 += var12 * var31;
            var29 += var20 * var31;
         ...
         if (var25 > Class_6ed.sub_48e(this.var_99)) {
            var25 = Class_6ed.sub_48e(this.var_99);
         }
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Class_6ed.sub_3dd(this.var_99);
