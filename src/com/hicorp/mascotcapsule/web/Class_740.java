...
public final class Class_740 extends Class_15d5 {
   private final Config var_1f;

   public Class_740(Config var1) {
      super(var1);
      this.var_1f = var1;
   }
   ...
   public void sub_22() {
      ...
      int var3 = Config.sub_509(this.var_1f).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      ...
      int var13 = Config.sub_55c(this.var_1f).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      ...
      if (super.var_8b < Config.sub_41a(this.var_1f)) {
         int var22;
         if (super.var_e8 < Config.sub_41a(this.var_1f)) {
            var22 = super.var_e8 - super.var_8b;
            super.var_8b = super.var_e8;
         } else {
            var22 = Config.sub_41a(this.var_1f) - super.var_8b;
            super.var_8b = Config.sub_41a(this.var_1f);
         }

         super.var_41 = super.var_41 + Config.sub_3dd(this.var_1f) * var22;
      ...
      for (super.var_e8 = super.var_e8 < Config.sub_45d(this.var_1f) ? super.var_e8 : Config.sub_45d(this.var_1f);
         super.var_8b < super.var_e8;
         ...
         if (var23 > Config.sub_48e(this.var_1f)) {
            var23 = Config.sub_48e(this.var_1f);
         }
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Config.sub_3dd(this.var_1f);
