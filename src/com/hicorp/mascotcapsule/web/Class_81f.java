...
public final class Class_81f extends Class_15d5 {
   private final Class_6ed var_64;

   public Class_81f(Class_6ed var1) {
      super(var1);
      this.var_64 = var1;
   }

   public void sub_22() {
      int[] var1 = Class_6ed.sub_34c(this.var_64);
      int var2 = (super.var_478 > 0 ? super.var_478 : -super.var_478) + (super.var_510 > 0 ? super.var_510 : -super.var_510) + 32768;
      int var3 = Class_6ed.sub_509(this.var_64).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Class_6ed.sub_509(this.var_64).sub_93();
      int var5 = Class_6ed.sub_509(this.var_64).sub_327(var3);
      int var6 = Class_6ed.sub_509(this.var_64).sub_3df(var3);
      int var7 = Class_6ed.sub_509(this.var_64).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_64).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_64).sub_467(var3);
      ...
      int var13 = Class_6ed.sub_55c(this.var_64).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Class_6ed.sub_55c(this.var_64).sub_93();
      int var15 = Class_6ed.sub_55c(this.var_64).sub_327(var13);
      int var16 = Class_6ed.sub_55c(this.var_64).sub_3df(var13);
      int var17 = Class_6ed.sub_55c(this.var_64).sub_418(var13);
      int var18 = Class_6ed.sub_55c(this.var_64).sub_42b(var13);
      int var19 = Class_6ed.sub_55c(this.var_64).sub_467(var13);
      int var20 = super.var_54a >> var13;
      int var21 = super.var_55b >> var13;
      if (super.var_8b < Class_6ed.sub_41a(this.var_64)) {
         int var22;
         if (super.var_e8 < Class_6ed.sub_41a(this.var_64)) {
            var22 = super.var_e8 - super.var_8b;
            super.var_8b = super.var_e8;
         } else {
            var22 = Class_6ed.sub_41a(this.var_64) - super.var_8b;
            super.var_8b = Class_6ed.sub_41a(this.var_64);
         }

         super.var_41 = super.var_41 + Class_6ed.sub_3dd(this.var_64) * var22;
      ...
      for (super.var_e8 = super.var_e8 < Class_6ed.sub_45d(this.var_64) ? super.var_e8 : Class_6ed.sub_45d(this.var_64);
         super.var_8b < super.var_e8;
         ...
         if (var41 < Class_6ed.sub_467(this.var_64)) {
            int var29 = Class_6ed.sub_467(this.var_64) - var41;
            var41 = Class_6ed.sub_467(this.var_64);
            var24 += var10 * var29;
            var25 += var11 * var29;
            var26 += var12 * var29;
            var27 += var20 * var29;
         ...
         if (var23 > Class_6ed.sub_48e(this.var_64)) {
            var23 = Class_6ed.sub_48e(this.var_64);
         }
         ...
         super.var_8b++;
         super.var_41 = super.var_41 + Class_6ed.sub_3dd(this.var_64);
