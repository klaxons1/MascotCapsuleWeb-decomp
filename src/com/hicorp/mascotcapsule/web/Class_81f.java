...
public final class Class_81f extends Class_15d5 {
   private final Config var_64;

   public Class_81f(Config var1) {
      super(var1);
      this.var_64 = var1;
   }
   ...
   public void sub_22() {
      ...
      int var3 = Config.sub_509(this.var_64).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_64).sub_93();
      int var5 = Config.sub_509(this.var_64).sub_327(var3);
      int var6 = Config.sub_509(this.var_64).sub_3df(var3);
      int var7 = Config.sub_509(this.var_64).sub_418(var3);
      int var8 = Config.sub_509(this.var_64).sub_42b(var3);
      int var9 = Config.sub_509(this.var_64).sub_467(var3);
      ...
      int var13 = Config.sub_55c(this.var_64).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var14 = Config.sub_55c(this.var_64).sub_93();
      int var15 = Config.sub_55c(this.var_64).sub_327(var13);
      int var16 = Config.sub_55c(this.var_64).sub_3df(var13);
      int var17 = Config.sub_55c(this.var_64).sub_418(var13);
      int var18 = Config.sub_55c(this.var_64).sub_42b(var13);
      int var19 = Config.sub_55c(this.var_64).sub_467(var13);
      ...
      for (super.var_e8 = super.var_e8 < Config.sub_45d(this.var_64) ? super.var_e8 : Config.sub_45d(this.var_64);
         ...
         if (var41 < Config.sub_467(this.var_64)) {
            int var29 = Config.sub_467(this.var_64) - var41;
            var41 = Config.sub_467(this.var_64);
            var24 += var10 * var29;
            var25 += var11 * var29;
            var26 += var12 * var29;
            var27 += var20 * var29;
