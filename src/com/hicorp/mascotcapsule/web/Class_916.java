...
public final class Class_916 extends MeshLoader {
   private final Config var_80;

   public Class_916(Config var1) {
      super(var1);
      this.var_80 = var1;
   }
   ...
   public void sub_81() {
      ...
      int var8 = Config.sub_509(this.var_80).sub_418(var4);
      int var9 = Config.sub_509(this.var_80).sub_42b(var4);
      int var10 = Config.sub_509(this.var_80).sub_467(var4);
      ...
      for (super.var_2c9 += 8388608; super.var_aa < super.var_bc; super.var_2c9 = super.var_2c9 + super.var_3a2) {
         ...
         super.var_aa++;
         super.var_5f = super.var_5f + Config.sub_3dd(this.var_80);
