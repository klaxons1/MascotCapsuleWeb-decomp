...
public final class Class_b0e extends MeshLoader {
   private final Config var_3a;

   public Class_b0e(Config var1) {
      super(var1);
      this.var_3a = var1;
   }
   ...
   public void sub_81() {
      ...
      int var4 = Config.sub_509(this.var_3a).sub_2cf(MatrixUtils.sub_30a(var3) - 17);
      int[] var5 = Config.sub_509(this.var_3a).sub_93();
      int var6 = Config.sub_509(this.var_3a).sub_327(var4);
      int var7 = Config.sub_509(this.var_3a).sub_3df(var4);
      int var8 = Config.sub_509(this.var_3a).sub_418(var4);
      int var9 = Config.sub_509(this.var_3a).sub_42b(var4);
      int var10 = Config.sub_509(this.var_3a).sub_467(var4);
