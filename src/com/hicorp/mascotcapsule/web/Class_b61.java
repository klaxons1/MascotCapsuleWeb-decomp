...
public final class Class_b61 extends Class_15c {
   private final Class_6ed var_c7;

   public Class_b61(Class_6ed var1) {
      super(var1);
      this.var_c7 = var1;
   }

   public void sub_26() {
      int[] var1 = Class_6ed.sub_34c(this.var_c7);
      int var2 = (super.var_2d1 > 0 ? super.var_2d1 : -super.var_2d1) + (super.var_319 > 0 ? super.var_319 : -super.var_319) + 32768;
      int var3 = Class_6ed.sub_509(this.var_c7).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Class_6ed.sub_509(this.var_c7).sub_93();
      int var5 = Class_6ed.sub_509(this.var_c7).sub_327(var3);
      int var6 = Class_6ed.sub_509(this.var_c7).sub_3df(var3);
      int var7 = Class_6ed.sub_509(this.var_c7).sub_418(var3);
      int var8 = Class_6ed.sub_509(this.var_c7).sub_42b(var3);
      int var9 = Class_6ed.sub_509(this.var_c7).sub_467(var3);
      ...
      for (int var12 = super.var_339; super.var_6c < super.var_81; super.var_216 = super.var_216 + super.var_282) {
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Class_6ed.sub_3dd(this.var_c7);
