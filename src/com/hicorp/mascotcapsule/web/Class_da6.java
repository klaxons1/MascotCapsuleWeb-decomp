...
public final class Class_da6 extends MeshLoader {
   ...
   public void sub_81() {
      int[] var1 = Config.sub_34c(this.var_e1);
      ...
      int var4 = Config.sub_509(this.var_e1).sub_2cf(MatrixUtils.sub_30a(var3) - 17);
      int[] var5 = Config.sub_509(this.var_e1).sub_93();
      int var6 = Config.sub_509(this.var_e1).sub_327(var4);
      int var7 = Config.sub_509(this.var_e1).sub_3df(var4);
      int var8 = Config.sub_509(this.var_e1).sub_418(var4);
      int var9 = Config.sub_509(this.var_e1).sub_42b(var4);
      int var10 = Config.sub_509(this.var_e1).sub_467(var4);
      int var11 = super.var_3bf >> var4;
      int var12 = super.var_3d8 >> var4;
      int var13 = super.var_403;
      int var14 = super.var_45b;
      int var15 = Config.sub_52c(this.var_e1);
      int var16 = 255 - Config.sub_52c(this.var_e1);
      if (super.var_aa < Config.sub_41a(this.var_e1)) {
         int var17;
         if (super.var_bc < Config.sub_41a(this.var_e1)) {
            var17 = super.var_bc - super.var_aa;
            super.var_aa = super.var_bc;
         } else {
            var17 = Config.sub_41a(this.var_e1) - super.var_aa;
            super.var_aa = Config.sub_41a(this.var_e1);
         }

         super.var_5f = super.var_5f + Config.sub_3dd(this.var_e1) * var17;
      ...
      super.var_bc = super.var_bc < Config.sub_45d(this.var_e1) ? super.var_bc : Config.sub_45d(this.var_e1);
      ...
      for (super.var_2c9 += 8388608; super.var_aa < super.var_bc; super.var_2c9 = super.var_2c9 + super.var_3a2) {
         ...
         if (var33 < Config.sub_467(this.var_e1)) {
            int var23 = Config.sub_467(this.var_e1) - var33;
            var33 = Config.sub_467(this.var_e1);
            var19 += var11 * var23;
            var20 += var12 * var23;
            var21 += var13 * var23;
            var22 += var14 * var23;
         ...
         if (var18 > Config.sub_48e(this.var_e1)) {
            var18 = Config.sub_48e(this.var_e1);
         }
         ...
         super.var_aa++;
         super.var_5f = super.var_5f + Config.sub_3dd(this.var_e1);
