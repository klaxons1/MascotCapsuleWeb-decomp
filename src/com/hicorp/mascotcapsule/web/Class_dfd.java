...
public final class Class_dfd extends ModelLoader {
   private final Config var_10f;

   public Class_dfd(Config var1) {
      super(var1);
      this.var_10f = var1;
   }

   public void sub_26() {
      int[] var1 = Config.sub_34c(this.var_10f);
      int var2 = (super.var_2d1 > 0 ? super.var_2d1 : -super.var_2d1) + (super.var_319 > 0 ? super.var_319 : -super.var_319) + 32768;
      int var3 = Config.sub_509(this.var_10f).sub_2cf(MatrixUtils.sub_30a(var2) - 17);
      int[] var4 = Config.sub_509(this.var_10f).sub_93();
      int var5 = Config.sub_509(this.var_10f).sub_327(var3);
      int var6 = Config.sub_509(this.var_10f).sub_3df(var3);
      int var7 = Config.sub_509(this.var_10f).sub_418(var3);
      int var8 = Config.sub_509(this.var_10f).sub_42b(var3);
      int var9 = Config.sub_509(this.var_10f).sub_467(var3);
      int var10 = super.var_2d1 >> var3;
      int var11 = super.var_319 >> var3;
      int var12 = super.var_339;
      if (super.var_6c < Config.sub_41a(this.var_10f)) {
         int var13;
         if (super.var_81 < Config.sub_41a(this.var_10f)) {
            var13 = super.var_81 - super.var_6c;
            super.var_6c = super.var_81;
         } else {
            var13 = Config.sub_41a(this.var_10f) - super.var_6c;
            super.var_6c = Config.sub_41a(this.var_10f);
         }

         super.var_31 = super.var_31 + Config.sub_3dd(this.var_10f) * var13;
      ...
      for (super.var_81 = super.var_81 < Config.sub_45d(this.var_10f) ? super.var_81 : Config.sub_45d(this.var_10f);
         super.var_6c < super.var_81;
         ...
         if (var25 < Config.sub_467(this.var_10f)) {
            int var18 = Config.sub_467(this.var_10f) - var25;
            var25 = Config.sub_467(this.var_10f);
            var15 += var10 * var18;
            var16 += var11 * var18;
            var17 += var12 * var18;
         }

         if (var14 > Config.sub_48e(this.var_10f)) {
            var14 = Config.sub_48e(this.var_10f);
         }
         ...
         super.var_6c++;
         super.var_31 = super.var_31 + Config.sub_3dd(this.var_10f);
