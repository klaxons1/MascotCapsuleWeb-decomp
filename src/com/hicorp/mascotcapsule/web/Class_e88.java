...
public final class Class_e88 extends MeshLoader {
   ...
   public void sub_81() {
      int[] var1 = Config.sub_34c(this.var_2f);
      ...
      int var4 = Config.sub_509(this.var_2f).sub_2cf(MatrixUtils.sub_30a(var3) - 17);
      int[] var5 = Config.sub_509(this.var_2f).sub_93();
      int var6 = Config.sub_509(this.var_2f).sub_327(var4);
      int var7 = Config.sub_509(this.var_2f).sub_3df(var4);
      int var8 = Config.sub_509(this.var_2f).sub_418(var4);
      int var9 = Config.sub_509(this.var_2f).sub_42b(var4);
      int var10 = Config.sub_509(this.var_2f).sub_467(var4);
      int var11 = super.var_3bf >> var4;
      int var12 = super.var_3d8 >> var4;
      int var13 = super.var_403;
      int var14 = super.var_45b;
      if (super.var_aa < Config.sub_41a(this.var_2f)) {
         int var15;
         if (super.var_bc < Config.sub_41a(this.var_2f)) {
            var15 = super.var_bc - super.var_aa;
            super.var_aa = super.var_bc;
         } else {
            var15 = Config.sub_41a(this.var_2f) - super.var_aa;
            super.var_aa = Config.sub_41a(this.var_2f);
         }

         super.var_5f = super.var_5f + Config.sub_3dd(this.var_2f) * var15;
      ...
      super.var_bc = super.var_bc < Config.sub_45d(this.var_2f) ? super.var_bc : Config.sub_45d(this.var_2f);
      ...
      for (super.var_2c9 += 8388608; super.var_aa < super.var_bc; super.var_2c9 = super.var_2c9 + super.var_3a2) {
         ...
         if (var31 < Config.sub_467(this.var_2f)) {
            int var21 = Config.sub_467(this.var_2f) - var31;
            var31 = Config.sub_467(this.var_2f);
            var17 += var11 * var21;
            var18 += var12 * var21;
            var19 += var13 * var21;
            var20 += var14 * var21;
         ...
         if (var16 > Config.sub_48e(this.var_2f)) {
            var16 = Config.sub_48e(this.var_2f);
         }
         ...
         super.var_aa++;
         super.var_5f = super.var_5f + Config.sub_3dd(this.var_2f);
